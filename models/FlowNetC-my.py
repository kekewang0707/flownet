...
class FlowNetC(nn.Module):
    ...
    def __init__(self, batchNorm=True):
        ...
        self.offsets = nn.Conv2d(512, 2, kernel_size=3, padding=1)
        self.deconv = Deform2D()
    ...
    def forward(self, x):
        ...
        offsets = torch.cat((out_conv3a, out_conv3b), 1)
        offsets = self.offsets(offsets)
        out_conv3a = self.deconv(out_conv3a, offsets)
